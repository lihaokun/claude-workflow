...
*本 expectations 由 Step 0 **从契约文档独立抽取**（禁止从代码回填）。任何后续修改必须先改契约文档，再同步本表——bug 类契约修复见 workflow.md §5 文档同步要求（§5.1 第五部分"文档更新清单"）；feature 类契约扩展按 §6.4 文档划分原则判定是续做本子计划还是开新子计划。*
